...
class RSCoder(object):
    ...
    def _chien_search(self, sigma):
        ...
        for l in range(1,256):
            ...
            power = p ** l
            # print('Evaluating sigma at', int(power))  # Debug print 
            if sigma.evaluate( power ) == 0:
                # print('Found root at', int(power), l, int(power.inverse()))  # Debug print
                X.append( power.inverse() )
                j.append(255 - l)
